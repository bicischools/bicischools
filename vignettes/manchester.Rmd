...
<!-- https://get-information-schools.service.gov.uk/Downloads/Generated/d74b2009-5571-496b-b102-c08765cb62f6 -->
...
od_standard = od_standard |> 
  mutate(origin = id,
         destination = "d")

routes = bici_routes(od.data = od_standard,
                     origin.col = "origin",
...
We order the routes to find which can benefit the greatest number of students
...
# routes_crop = sf::st_intersection(route_summaries, rnet_buffer)
# 
