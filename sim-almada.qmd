...
The input datasets are illustrated in the figure below (these are census data for BGRI zones in Almada (Lisbon Metropolitan Area), and student numbers for Ciclo 1 schools in Almada):
...
g2 = schools_c1 |>
    ggplot() +
    geom_sf(size = schools_c1$STUDENTS/100) +
